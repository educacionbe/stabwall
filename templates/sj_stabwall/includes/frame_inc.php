...
**********************************************************************/
// Bootstrap CSS
if(!$direction['rtl']){$yt->ytStyleSheet('asset/bootstrap/css/bootstrap.min.css');}
...
$yt->ytStyleSheet('asset/slick/slick-theme.css');
$yt->ytStyleSheet('css/template.css');
$yt->ytStyleSheet('css/system/pattern.css');
$yt->ytStyleSheet('css/your_css.css');

// Font awesome
if(!defined('FONT_AWESOME')){$yt->ytStyleSheet('asset/fonts/font-awesome-4.4.0/css/font-awesome.css'); define('FONT_AWESOME', 1);}
...
$doc->addScript($yt->templateurl().'js/slick.min.js');
$doc->addScript($yt->templateurl().'js/masonry.pkgd.min.js');

// Include Courntdow time
$doc->addScript($yt->templateurl().'/js/jquery.plugin.js');
