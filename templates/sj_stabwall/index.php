...
<body id="bd" class="<?php echo $cls_body; ?>" >
	...
	<header class="ip-header">
		<h1 class="ip-logo">
			<?php
				$logoloadding = $logoload ? $logoload : JURI::base() . "templates/" . $this->template ."/images/logo-loading.png";
			?>
			<img class="transparent" src="<?php echo $logoloadding; ?>" alt="<?php echo $logoloadding?>">
		</h1>
		<div class="ip-loader">
		...
		foreach($yt_render->arr_TB as $tagBD) {
			...
			if( $tagBD["countModules"] > 0 ) {
				if( ($tagBD["name"] == 'sidebar') ) {
					$sidebar = 1;
					echo "<div id=\"{$tagBD['id']}\" class=\"block \" > <div class=\"sidebar-close fa fa-times\"></div>";
					?>
                    ...
                    <?php
					echo "</div>";
					echo '<div class="sidebar-open fa fa-bars" id="sidebar-open"></div><div id="page-content-wrapper" class="page-content-wrapper">';
