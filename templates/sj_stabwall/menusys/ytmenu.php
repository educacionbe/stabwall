		...
		public function getLink(){
			...
			if (isset($menu_image) && $menu_image!='-1' && !empty($menu_image)){
				...
				if(count($this->_child) >= 1 || count($this->loadModules() ) ){
					...
					if ($this->level > 1) $menu_arrow = "<i class=\"fa fa-angle-double-right\"></i>";
				}
				...
				$menu_arrow ="";
				if(count($this->_child) >= 1 || count($this->loadModules() ) ){
					if($this->level==1) $menu_arrow = "";
					else if ($this->level > 1) $menu_arrow = "<i class=\"fa fa-angle-double-right\"></i>";
				}
