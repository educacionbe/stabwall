...
if (!empty($list)) {
    ...
    <!--[if gt IE 9]><!-->
    <div id="<?php echo $tag_id; ?>" data-sr="enter bottom and move  200px over 1s" class="sj-extraslider <?php if ($options->effect == 'slide') { echo $options->effect; } ?> <?php echo $class_respl; ?> <?php echo $btn_type; ?>"><!--<![endif]-->
                ...
                <div class="item-wrap <?php echo $items_style; ?>">
                    <div class="item-wrap-inner">
						...
						<time datetime="<?php echo JHtml::_('date', $item->created, 'c'); ?>" >
							<?php
								$time = explode(' ', JText::sprintf( JHtml::_('date', $item->created, JText::_('d M'))));
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function ($) {
			...
			//alert($('.extraslider-inner').height());
			$('.sj-extraslider .owl-item').css("height", $('.sj-extraslider .center .item-wrap-inner').height());
        });
        //]]>
    </script>
