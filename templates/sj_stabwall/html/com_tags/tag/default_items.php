						...
						<div class="article-text media-body">
							...
							<aside class="article-aside">
								<dl class="article-info  muted">
									<dd class="create"><i class="fa fa-clock-o"></i><?php echo JText::sprintf( JHTML::_('date',$item->tag_date, JText::_('DATE_FORMAT_LC3'))); ?></dd>
								</dl>
							</aside>
							<?php if ($this->params->get('all_tags_show_tag_descripion', 1)) : ?>
								<div class="article-intro">
									<?php //echo JHtml::_('string.truncate', $item->core_body, $this->params->get('all_tags_tag_maximum_characters')); ?>
									<?php echo substr($item->core_body,  0, $this->params->get('all_tags_tag_maximum_characters')); ?>
								</div>
