...
<div class="blog blog-featured<?php echo $this->pageclass_sfx;?>">
	...
	<div class="items-leading row">
		...
		<?php foreach ($this->lead_items as &$item) : ?>
			<div class="item col-sm-<?php echo round((12 / $this->params->get('num_columns')));?> leading-<?php echo $leadingcount; ?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?>">
				<?php
					$this->item = &$item;
					// Begin: dunnv edited
					$leadingFlag = 1;
