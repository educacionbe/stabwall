...
<!--[if gt IE 9]><!--><div class="contact-ajax" id="<?php echo $tag_id; ?>" ><!--<![endif]--> 
	<div class="ctajax-wrap bigmapmod">
		...
		<?php
			...
			$contact = $doc->getBuffer('modules', 'contact', array('style' => 'none'));
		?>
		<?php if($contact) : ?>
		...
		<?php endif; ?>
		<div class="contact-wrapper module">
		<div class="container">
		
			<div class="block-title">
				<h3 class="modtitle"><?php echo JText::_('GET_IN_TOUCH_WITH_US'); ?></h3>
				<p><?php echo JText::_('CONTACT_DES'); ?></p>
			</div>
			<div class="row">
				<div class="ctajax-element col-md-6 col-sm-6">
					<div class="el-inner cf">
						<div class="el-form cf">
							<h2 class="el-heading"><span><?php echo JText::_('CONTACT_US_TITLE');?></span></h2>
				...
				<div class="ctajax-element col-md-6 col-sm-6">
					<div class="el-inner">
						<h2 class="el-heading"><span><?php echo JText::_('INFORMATION_TITLE');?></span></h2>
					...
					<div class="el-inner">
						<div class="el-info-contact">
							<h2 class="el-heading"><span><?php echo JText::_('OUR_OFFICE');?></span></h2>
							<?php $address = trim($list->address);
							if($address != '') {
							?>
							<div class="info-address cf">
								<i class="icon-map-marker"></i>
								<span class="info-label" data-label="<?php echo JText::_('ADD_LABEL_OFFICE') ?>">: <?php echo $address; ?></span>
							</div>
							<?php }
							...
							<div class="info-mail cf">
								...
								<a href="mailto:<?php echo $mail_to; ?>" class="info-label" data-label="<?php echo JText::_('EMAIL_LABEL') ?>">: <?php echo $mail_to; ?></a>
							</div>
							<?php } 
							...
							<div class="info-mobie cf">
								...
								<span class="info-label" data-label="<?php echo JText::_('PHONE_LABEL') ?>">: <?php echo $mobile; ?></span>
							</div>
							<?php } ?>
						</div>
					</div>
					<div class="el-inner">
						<div class="social-networks">
							<h2 class="el-heading"><span><?php echo JText::_('SOCIAL_SHARE');?></span></h2>
							<?php 
