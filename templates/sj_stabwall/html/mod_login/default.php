...
?>
<form action="<?php echo JRoute::_(htmlspecialchars(JUri::getInstance()->toString()), true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form">
	...
	<div class="userdata">
		...
		<?php if ($usersConfig->get('allowUserRegistration')) : ?>
			<div class="unstyled pull-right">
				...
				<?php echo JText::_('MY_MOD_LOGIN_REGISTER'); ?> <span class="icon-arrow-right"></span></a>
			</div>
		<?php endif; ?>
